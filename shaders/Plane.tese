...
void main()
{
    ...
    vec3 tangent = vertexData[0].tangent * gl_TessCoord.x + vertexData[1].tangent * gl_TessCoord.y + vertexData[2].tangent * gl_TessCoord.z;
    vec3 bitangent = vertexData[0].bitangent * gl_TessCoord.x + vertexData[1].bitangent * gl_TessCoord.y + vertexData[2].bitangent * gl_TessCoord.z;
    ...
    vertexDataOut.tangent = tangent;
    vertexDataOut.bitangent = bitangent;

...
class BasicMesh : public Mesh<Vertex>
{
public:
...
template<typename Vertex>
void BasicMesh<Vertex>::createPipeline(const uint32_t pipelineIndex, const VertexDescription& vertexDescription, const std::vector<spk::ShaderInfo> shaderInfos, const vk::Extent2D extent, const spk::AdditionalInfo& info)
{

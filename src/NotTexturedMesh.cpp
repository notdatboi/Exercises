#include"../include/NotTexturedMesh.hpp"
...
void NotTexturedMesh::createPipeline(const uint32_t pipelineIndex, const std::vector<spk::ShaderInfo> shaderInfos, const vk::Extent2D extent, const spk::AdditionalInfo& info)
{
    ...
    vk::VertexInputAttributeDescription positionAttribute, normalAttribute;
    ...
    vertexInputState.attributeDescriptions = {positionAttribute, normalAttribute};
